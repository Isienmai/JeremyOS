...
//allow the caller to specify the minimum length of the printed string
void ConsoleWriteIntMinLength(unsigned int i, unsigned int base, unsigned int minimumLength); 
